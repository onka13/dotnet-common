...
using DotNetCommon.Business.Service.Helpers;
using DotNetCommon.Data.Domain.Config;
...
namespace DotNetCommon.Business.Service.Base
{
    /// <summary>
    /// Startup base class
    /// </summary>
    public abstract class StartupBase
    {
        ...
        {
            DependencyHelper.RegisterCommonTypes(builder, typeof(DotNetCommon.Data.EntityFrameworkBase.Components.EmptyDbContext));
