...
public class StringHelper
{
    ...
    {
        return Regex.Replace(txt, @"[^A-Z]+", string.Empty);
    }
    ...
    {
        return CultureInfo.CurrentCulture.TextInfo.ToTitleCase(txt ?? string.Empty);
    }
    ...
    public static string SentenceCase(string txt)
    {
        ...
        var result = regex.Replace((txt ?? string.Empty).ToLower(), s =>
        {
